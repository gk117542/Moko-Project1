...
extern uint8_t SOFTH_VERSION;
extern uint8_t SOFTL_VERSION;
extern uint8_t TEST_VERSION;
...
//    static char str_num_ber_buf[50];
    static char sw_buf[10];
    static char dd_buf[20];
    
    //device information.
    ble_dis_init_t dis_init;
    memset(&dis_init, 0, sizeof(dis_init));
    ble_srv_ascii_to_utf8(&dis_init.manufact_name_str, (char *)StuHis.manufactur_name_str);
    
  //  ble_srv_ascii_to_utf8(&dis_init.model_num_str, (char *)StuHis.product_type_str);
    
    memset(dd_buf,0,15);
    sprintf(dd_buf,"%d/%02d/%02d",(StuHis.produce_time[0]<<8)|StuHis.produce_time[1],StuHis.produce_time[2],StuHis.produce_time[3]);
    ble_srv_ascii_to_utf8(&dis_init.serial_num_str, (char *)dd_buf);
    
//	memset(StuHis.LOCAL_HARDWARE_VERSION_STR,0,11);
//	memcpy(StuHis.LOCAL_HARDWARE_VERSION_STR,"H152V1.2",strlen("H152V3.3"));
 //   ble_srv_ascii_to_utf8(&dis_init.hw_rev_str, (char *)StuHis.software_verison_str);

    memset(sw_buf,0,10);
    sprintf(sw_buf,"V%d.%d.%d",SOFTH_VERSION,SOFTL_VERSION,TEST_VERSION);
    ble_srv_ascii_to_utf8(&dis_init.fw_rev_str, (char *)sw_buf);//LOCAL_FIRMWARE_VERSION
    
//    ble_srv_ascii_to_utf8(&dis_init.sw_rev_str, (char *)StuHis.software_verison_str);
